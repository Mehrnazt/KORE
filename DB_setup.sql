...
IF NOT EXISTS (SELECT * FROM sys.databases WHERE name = N'KoreAssignment_Mehrnaz_Tajfar')
BEGIN
   --TODO: Replace {FirstName} and {LastName} with your actual first and last names before running this script
    CREATE DATABASE [KoreAssignment_Mehrnaz_Tajfar]
END
GO

USE [KoreAssignment_Mehrnaz_Tajfar]
GO
